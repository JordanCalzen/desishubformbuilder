...
export default function Header() {
	return (
		<div className="px-2 pt-2 sticky top-0 z-50 w-full">
			<header className=" border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 rounded-lg px-8">
				<div className=" flex h-16 items-center justify-between">
					...
					<nav className="hidden md:flex items-center gap-6">
						...
						<Button
							asChild
							className=" bg-transparent border border-blue-600 hover:bg-blue-700 text-blue-800 hover:text-white font-medium py-3 px-2 rounded-lg flex items-center gap-2"
						>
							<Link href="">
								Create a form
